...
package org.yausername.encryptedsharedpreferences;
...
import static org.yausername.encryptedsharedpreferences.MasterKeys.KEYSTORE_PATH_URI;
...
public final class EncryptedSharedPreferences implements SharedPreferences {
     ...
     * <p>
     * It is recommended to use {@link #AES256_SIV}.
     * <p>
     ...
     * It is recommended to use {@link #AES256_GCM} on Android M+ (API 23). On previous versions
     * of Android, the library automatically falls back to {@link #XCHACHA20_POLY1305}.
     * <p>
     * For more information please see the Tink documentation:
     * <p>
     * {@link AeadKeyTemplates#AES256_GCM}
     * {@link AeadKeyTemplates#XCHACHA20_POLY1305}
     */
    public enum PrefValueEncryptionScheme {
        @RequiresApi(Build.VERSION_CODES.M)
        AES256_GCM(AeadKeyTemplates.AES256_GCM),
        XCHACHA20_POLY1305(AeadKeyTemplates.XCHACHA20_POLY1305);
            ...
            if (encryptedValue != null) {
                ...
                switch (type) {
                    ...
                    case STRING_SET:
                        ...
                        if (stringSet.size() == 1 && stringSet.contains(NULL_VALUE)) {
                            returnValue = null;
                        } else {
